...
<body>
<form id="formEE" name="formEE" method="GET" action="Courses.php">
...
?> <h2>Electrical Engineering Curriculum</h2>
   <h3>Please check current and completed courses!</h3>
<?php
...
<input type="submit" value="Submit"  onclick="saveResponse()">
